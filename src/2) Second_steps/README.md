* **3_Notebook-3_Extract_Features.ipynb**: This notebook is used to extract features from a public dataset extracted from a repository available on [GitHub](https://github.com/giulbia/baby_cry_detection.git).
